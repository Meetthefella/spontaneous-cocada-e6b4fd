...
const homepageSections = [
  {
    id:'hero',
    title:'Hero',
    description:'The main heading and opening message at the top of the website.',
    icon:'⌂',
    fields:[
      ['Main heading','Effortless Beauty'],
      ['Supporting line','Enhance. Simplify. Feel beautiful.'],
      ['Primary button','Book online'],
      ['Secondary button','Aftercare guide']
    ]
  },
  {
    id:'introduction',
    title:'Introduction',
    description:'The short welcome message beneath the hero area.',
    icon:'✦',
    fields:[
      ['Introduction','Soft, natural-looking brows and permanent makeup designed to make everyday beauty feel effortless.']
    ]
  },
  {
    id:'why-choose-us',
    title:'Why Choose Us',
    description:'The heading that introduces the reasons clients choose Effortless Beauty.',
    icon:'♡',
    fields:[
      ['Small heading','Why clients choose us'],
      ['Main heading','Polished results, calm appointments, clear aftercare.']
    ]
  },
  {
    id:'feature-cards',
    title:'Feature Cards',
    description:'The three reassurance cards shown on the homepage.',
    icon:'◇',
    features:[
      ['Natural finish','Designed to complement your face rather than overpower it.'],
      ['Low-maintenance beauty','Wake up with shape, definition and softness already in place.'],
      ['Client-friendly care','Aftercare is explained clearly, including the normal healing stages.']
    ]
  }
];
